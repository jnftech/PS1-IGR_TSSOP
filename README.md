# Playstation 1 In-Game Reset (IGR) Boards for Controller-board install


These boards are variations on PyroESP's [pyroesp's](https://github.com/pyroesp) Playstation 1 Reset Mod project. The original project and code can be found at https://github.com/pyroesp/PlayStation-1-Reset-Mod
...
- You will of course need a programmer to flash the code to the microcontroller, such as a PICkit3. This can be done in several ways:
  - The ICSP pads on the bottom of the board by soldering some temporary wiring to connect it to the programmer.
...
<p align="center">
  <img width="200" src="Images/PS1-IGR JFT CTRLR Center 3D Transparent.png">
</p>